import { A as Fragment, Bt as popScopeId, Cn as withScopeId, Et as nextTick, G as createElementBlock, Gn as shallowReactive, Gt as renderList, Hn as reactive, Ht as pushScopeId, Jt as resolveDirective, Kt as renderSlot, Q as createVNode, Rn as markRaw, Tt as mergeProps, U as createBlock, W as createCommentVNode, Yt as resolveDynamicComponent, ar as normalizeStyle, dt as h, ir as normalizeProps, qt as resolveComponent, rn as toHandlers, rr as normalizeClass, ut as guardReactiveProps, xn as withDirectives, yn as withCtx, zt as openBlock } from "./vue.runtime.esm-bundler-G78b_eY2.js";

//#region node_modules/vue-resize/dist/vue-resize.esm.js
...
//#endregion
//#region node_modules/vue-observe-visibility/dist/vue-observe-visibility.esm.js
...
//#endregion
//#region node_modules/vue-virtual-scroller/node_modules/mitt/dist/mitt.es.js
...
//#endregion
//#region node_modules/vue-virtual-scroller/dist/vue-virtual-scroller.esm.js
...
function IdState() {
	var _ref$idProp = (arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}).idProp, idProp = _ref$idProp === void 0 ? function(vm) {
		return vm.item.id;
	} : _ref$idProp;
	var store = reactive({});
	return {
		...
		created: function created() {
			var _this = this;
			this.$_id = null;
			if (typeof idProp === "function") this.$_getId = function() {
				return idProp.call(_this, _this);
			};
			else this.$_getId = function() {
				return _this[idProp];
			};
		...
		methods: {
			...
			$_updateIdState: function $_updateIdState() {
				var id = this.$_getId();
				if (id == null) console.warn("No id found for IdState with idProp: '".concat(idProp, "'."));
				if (id !== this.$_id) {
...
var plugin = {
	...
	install: function install(app, options) {
		...
		for (var key in finalOptions) if (typeof finalOptions[key] !== "undefined") config[key] = finalOptions[key];
		if (finalOptions.installComponents) registerComponents(app, finalOptions.componentsPrefix);
	}
};
